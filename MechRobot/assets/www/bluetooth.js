...
cordova.define("cordova/plugin/bluetooth", function(require, exports, module) {
	 ...
	 * 
	 * @param successCallback function to be called when writing was successfull. Passed parameter is a string containing the written content
	 * @param errorCallback function to be called when there was a problem while reading
	 */
	Bluetooth.prototype.write = function(successCallback,failureCallback,socketid, center_forward, center_backward, pivot_left, pivot_right, stop, step_cw, step_ccw, claw_open, claw_close, pause, reset /*micro_forward, micro_left*/) {
	    return exec(successCallback, failureCallback, 'BluetoothPlugin', 'write', [
	    		socketid, center_forward, center_backward, pivot_left, pivot_right,
	    		stop, step_cw, step_ccw, claw_open, claw_close, pause, reset /*micro_forward, micro_left */
	    	]
	    );
	}
